...
# Lọc danh sách quốc gia duy nhất
unique_countries = data['nationality'].dropna().unique()
...
# (Tùy chọn) Lưu danh sách vào file mới
output_path = 'unique_countries.txt'
with open(output_path, 'w') as f:
    for country in unique_countries:
        f.write(country + '\n')

print(f"Danh sách quốc gia đã được lưu tại {output_path}")
